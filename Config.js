const CONFIG = {
    ...
    BACKEND_QA_IP: "qa.api.bsquaresupermart.in",
    BACKEND_PROD_IP: "api.bsquaresupermart.in"
}
...
if(CONFIG.BACKEND_ENV === "LOCAL"){
    ...
    BACKEND_URI = "https://" + CONFIG.BACKEND_QA_IP;
}else if(CONFIG.BACKEND_ENV === "PROD"){
    BACKEND_URI = "https://" + CONFIG.BACKEND_PROD_IP;
}